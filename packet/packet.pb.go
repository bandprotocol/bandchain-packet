...
// source: oracle/v1/packet/packet.proto
...
func (ResolveStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e92cbf7fa321f89a, []int{0}
}
...
func (*OracleRequestPacketAcknowledgement) Descriptor() ([]byte, []int) {
	return fileDescriptor_e92cbf7fa321f89a, []int{1}
}
...
type OracleResponsePacketData struct {
	...
	// FAILURE, or EXPIRED.
	ResolveStatus ResolveStatus `protobuf:"varint,6,opt,name=resolve_status,json=resolveStatus,proto3,enum=oracle.v1.packet.ResolveStatus" json:"resolve_status,omitempty"`
...
func (*OracleResponsePacketData) Descriptor() ([]byte, []int) {
	return fileDescriptor_e92cbf7fa321f89a, []int{2}
}
...
func init() {
	proto.RegisterEnum("oracle.v1.packet.ResolveStatus", ResolveStatus_name, ResolveStatus_value)
	proto.RegisterType((*OracleRequestPacketData)(nil), "oracle.v1.packet.OracleRequestPacketData")
	proto.RegisterType((*OracleRequestPacketAcknowledgement)(nil), "oracle.v1.packet.OracleRequestPacketAcknowledgement")
	proto.RegisterType((*OracleResponsePacketData)(nil), "oracle.v1.packet.OracleResponsePacketData")
}

func init() { proto.RegisterFile("oracle/v1/packet/packet.proto", fileDescriptor_e92cbf7fa321f89a) }

var fileDescriptor_e92cbf7fa321f89a = []byte{
	// 681 bytes of a gzipped FileDescriptorProto
	,
}
